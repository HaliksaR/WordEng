...
void logo() {
    ...
    wprintf(L"%ls██████████████████████████████\n" , BLACK); delay_logo();
    gotoxy(12,6);   
    wprintf(L"████████%ls" L"███%ls" L"███████████████████\n", RED, BLACK); delay_logo();
    gotoxy(12,7);   
    wprintf(L"█████%ls" L"██%ls" L"███%ls" L"█████%ls" L"███████████████\n", RED, BLACK, RED, BLACK); delay_logo();
    gotoxy(12,8);   
    wprintf(L"███████%ls" L"█████████████%ls" L"██████████%ls\n", RED, BLACK, RED); delay_logo();
    gotoxy(12,9);   
    wprintf(L"████%ls" L"███%ls" L"█████████████████%ls" L"██████\n", BLACK,RED, BLACK); delay_logo();
    gotoxy(12,10);   
    wprintf(L"█████%ls" L"█████%ls" L"██%ls" L"███████%ls" L"██████████%ls" L"█\n", RED, WHITE, RED, WHITE, BLACK); delay_logo();
    gotoxy(12,11);   
    wprintf(L"█████%ls" L"█████%ls" L"██%ls" L"█████%ls" L"██%ls" L"██%ls" L"██%ls" L"████%ls" L"███%ls\n", RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK, RED); delay_logo();
    gotoxy(12,12);   
    wprintf(L"██%ls" L"█%ls" L"██████%ls" L"██%ls" L"█████%ls" L"██%ls" L"██%ls" L"██%ls" L"██████%ls" L"██\n", BLACK, RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,13);   
    wprintf(L"███%ls" L"█████%ls" L"██%ls" L"██%ls" L"██%ls" L"█%ls" L"██%ls" L"██%ls" L"██████%ls" L"███%ls" L"██\n", RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,14);   
    wprintf(L"█%ls" L"███████%ls" L"█%ls" L"██%ls" L"██%ls" L"██%ls" L"█%ls" L"██%ls" L"██%ls" L"████████%ls" L"██\n",  RED, WHITE, RED, WHITE, RED, WHITE , RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,15);   
    wprintf(L"█%ls" L"██████%ls" L"██%ls" L"█%ls" L"██%ls" L"██%ls" L"█%ls" L"██%ls" L"██%ls" L"█████████%ls" L"██\n", RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,16);   
    wprintf(L"███%ls" L"████%ls" L"█%ls" L"█%ls" L"█%ls" L"█%ls" L"█%ls" L"█%ls" L"█%ls" L"██%ls" L"██%ls" L"██%ls" L"███%ls" L"█████%ls" L"██\n", RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,17);   
    wprintf(L"████%ls" L"███%ls" L"██%ls" L"██%ls" L"███%ls" L"██%ls" L"████%ls" L"███████%ls" L"███\n", RED, WHITE, RED, WHITE, RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,18);   
    wprintf(L"█████%ls" L"██%ls" L"█%ls" L"██████████████████%ls" L"████\n", RED, WHITE, RED, BLACK); delay_logo();
    gotoxy(12,19);   
    wprintf(L"███████%ls" L"██████████████████%ls" L"█████\n", RED, BLACK); delay_logo();
    gotoxy(12,20);   
    wprintf(L"██████████%ls" L"███████████%ls" L"█████████%ls\n", RED, BLACK, RESET); delay_logo();
    gotoxy(5,22);   
